...
// const skills = ["Html", "CSS", "JavaScript", "ReactJs", "NodeJs", "ExpressJs", "MongoDB"];
const isResume = true;
        ...
        <div>
            ...
            <div className="max-w-4xl p-8 mx-auto my-5 bg-white border border-gray-200 rounded-2xl">
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5">
                    ...
                    {
                        isResume ? <a target="blank" href={user?.proifle?.resume} className="w-full text-blue-600 cursor-pointer hover:underline">{user?.profile?.resumeOriginalName}</a> : <span>Not Applicable</span>
                    }
                </div>
            </div>
